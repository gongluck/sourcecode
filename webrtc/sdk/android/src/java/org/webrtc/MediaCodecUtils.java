...
class MediaCodecUtils {
  ...
  static final int COLOR_QCOM_FORMATYVU420PackedSemiPlanar64x32Tile2m8ka =
    0x7FA30C03;
  ...
  static boolean codecSupportsType(
    MediaCodecInfo info,
  ...
  static Map<String, String> getCodecProperties(
    VideoCodecMimeType type,
    boolean highProfile
  ) {
    switch (type) {
  ...
  @TargetApi(29)
  private static boolean isHardwareAcceleratedQOrHigher(
  ...
  @TargetApi(29)
  private static boolean isSoftwareOnlyQOrHigher(
    android.media.MediaCodecInfo codecInfo
  ) {
