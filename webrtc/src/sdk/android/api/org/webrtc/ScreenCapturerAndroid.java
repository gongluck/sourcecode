...
public class ScreenCapturerAndroid implements VideoCapturer, VideoSink {
  ...
  private static final int DISPLAY_FLAGS =
    DisplayManager.VIRTUAL_DISPLAY_FLAG_PUBLIC |/*公共标识*/
    DisplayManager.VIRTUAL_DISPLAY_FLAG_PRESENTATION/*显示标识*/;
  ...
  public ScreenCapturerAndroid(
    ...
    this.mediaProjectionPermissionResultData =
  ...
  public synchronized void initialize(
    final SurfaceTextureHelper surfaceTextureHelper, //负责创建surfaceTexture,接收图像数据
    final Context applicationContext, //负责创建MediaProjectionManager,用于创建MediaProjection
    final CapturerObserver capturerObserver //负责数据回调
  ) {
    checkNotDisposed();
  ...
  public synchronized void startCapture(
    ...
    //开始监听 接收到数据会调用ScreenCapturerAndroid.this.onFrame
  ...
  private void createVirtualDisplay() {
    ...
    virtualDisplay =
      mediaProjection.createVirtualDisplay(
        ...
        VIRTUAL_DISPLAY_DPI,
        DISPLAY_FLAGS,
        new Surface(surfaceTextureHelper.getSurfaceTexture()), //帧数据由MediaProjection截取，送入这个Surface
        null/* callback */,
        null
        /* callback handler */
      );
