...
namespace std _GLIBCXX_VISIBILITY(default)
{
  ...
  protected:
    ...
    typedef typename _Alloc_traits::template rebind<_Fwd_list_node<_Tp>>::other _Node_alloc_type;
  ...
  public:
     ...
     */
    explicit forward_list(const _Alloc &__al = _Alloc())
     ...
     */
    void
    swap(forward_list &__list) noexcept(_Node_alloc_traits::_S_nothrow_swap())
    {
