...
private:
  ...
  _Rep_type _M_t; // Red-black tree representing set. //内部红黑树
...
public:
  ...
  {
    _M_t._M_insert_unique(__first, __last); // 插入到红黑树
  }
   ...
   */
  set(set &&__x) : _M_t(std::forward<_Rep_type>(__x._M_t)) {}
   ...
   */
  set(initializer_list<value_type> __l, const _Compare &__comp = _Compare(), const allocator_type &__a = allocator_type()) : _M_t(__comp, __a)
  {
